 ...
 * 
 * <p>
 * A <code>Entity.TicketPrice</code> object used
...
public class TicketPrice {
     ...
     * @return Enum.DayTypeEN the day type
     */
     ...
     * @return Enum.ScreenClassEN the type of screen class (PLATINUM_MOVIE_SUITES or REGULAR_SCREEN)
     */
     ...
     * @return Enum.MovieGoerAgeEN the type of movie goer age group (ADULT,SENIOR,CHILD or STUDENT)
     */
     ...
     * @return Enum.MovieTypeEN the type of movie(BLOCKBUSTER,THREEDIMENSION or DOCUMENTARY)
     */
    ...
    /**
     * The constructor of Entity.TicketPrice object
